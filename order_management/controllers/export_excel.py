...
class MaterialInvoiceExportController(http.Controller):
    ...
    @http.route('/export/material/<int:invoice_id>', type='http', auth='user')
    def export_material_excel(self, invoice_id, **kwargs):
        ...
        template_path = os.path.join(module_path, '../static/src/xlsx/export_invoice.xlsx')
        ...
        filename = f'vat_tu_export_{current_time}.xlsx'
