...
class StyleColorSizeImportWizard(models.TransientModel):
    _name = 'style.color.size.import.wizard'
    _description = 'Wizard Import Style + Color + Size theo Style'
    ...
    def import_excel(self):
        ...
        for index, row in df.iterrows():
            ...
            if code_rec:
                ...
                raise UserError(f"Không tìm thấy bản ghi để cập nhật cho Style: '{self.product_code_id.name}'.")
    ...
    def action_download_template(self):
        return {
            ...
            'url': '/order_management/static/src/xlsx/import_style_excel/form_style_color_size_.xlsx',
            'target': 'self',
        }
