...
class StockDashboard extends Component {
    ...
    get filteredXntReportList() {
        ...
        if (!searchTerm) {
            return this.state.xnt_report_lines;
        }
        return this.state.xnt_report_lines.filter(line => {
    ...
    get filteredOrderList() {
        ...
        if (!searchTerm) {
            return this.state.order_list;
        }
        return this.state.order_list.filter(order => {
    ...
    get filteredStockList() {
        ...
        if (!searchTerm) {
            return this.state.stock_list;
        }
        return this.state.stock_list.filter(stock => {
